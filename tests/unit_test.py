...
def test_readme():
    ...
    haplotypes, *_ = solve_MEC(fragments)
...
def test_simple_matrix():
    ...
    haplotypes, *_ = solve_MEC(allele_matrix)
    assert set(haplotypes) == {(0, 0, 1, 1), (1, 1, 0, 0)}
...
def test_homozygous_variants():
    ...
    haplotypes, *_ = solve_MEC(allele_matrix, call_homozygous=True)
...
def test_empty_fragments():
    ...
    haplotypes, partition, cost = solve_MEC(allele_matrix)
    assert set(haplotypes) == {(0, 1, 1), (1, 0, 0)}
    assert partition in ((0, 1, -1, -1), (1, 0, -1, -1))
...
def test_sparse_matrix():
    ...
    assert list(result1.partition) == list(result2.partition)
